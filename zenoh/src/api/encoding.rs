...
impl Encoding {
    ...
    /// Application-specific [Avro](https://avro.apache.org/)-encoded data.
    ///
    /// Constant alias for string: `"application/avro"`.
    pub const APPLICATION_AVRO: Encoding = Self(zenoh_protocol::core::Encoding {
        id: 53,
        schema: None,
    });
